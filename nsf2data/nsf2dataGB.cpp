...
int main(int argc,char *argv[])
{
	...
	if(argc<2)
	{
		...
		printf("Gameboy Port 2019, only channels 1,2,4 supported\n");
		printf("Usage: nsf2dataGB.exe filename.nsf\n");
	...
	fprintf(out_file,";This file for FamiTone2 libary generated by nsf2dataGB tool\n\n");
...
//	if(ntsc)
	{
		...
		for(i=0;i<nsf_songs;++i) fprintf(out_file,"\t%s %ssfx_gb_%i\n",DW,LL,i);
	}
...
*/
	...
	printf("\nNOTE: don't use channel 3, not yet supported.\n");
