// text2dataGB.cpp : nesdoug bug fix fork
// some changes marked with **
// GB fork, Doug Fraker 2019
...
int output_header(char* songname, int song)
{
	...
	fprintf(outfile, ";this file for FamiTone2 GB library generated by text2dataGB tool\n\n");
...
int main(int argc, char* argv[])
{
	...
	if (argc < 2)
	{
		...
		printf("Usage: text2data.exe song.txt [-ch1..4][-s][-allin][-Wno]\n");
	...
	for (i = 1; i < argc; ++i)
	{
		...
		if (!_stricmp(argv[i], "-Wno"))    no_warnings = 1;
